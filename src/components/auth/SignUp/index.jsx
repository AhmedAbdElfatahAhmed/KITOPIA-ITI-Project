    ...
    <div className="container">
      <div className="row">
        ...
        <div className="col-md-6">
          <Form onSubmit={handleSubmit(onSubmit)} className=" p-5 w-100 text-info  mt-5">

            <div className="row ">
              {/* parent & child */}
              <div className="col-md-6  parent-child w-100 m-auto  card py-4">
                {/* parent */}
                ...
                <div className="child d-flex justify-content-around     py-2">
                  ...
                  <div className="iputs w-50 px-2">
                    ...
                    <Form.Group className="mb-3" controlId="formBasicimage">
                      <section>
                        <div className="uploading card text-center p-2">
                                ...
                                selectedImages.map((image) => {
                                  return (
                                    <div key={image} className="image">
                                      <img src={image} className="w-100 m-auto card" alt="upload" />
                                    </div>
                                  );
                                })}
                            </div>
            ...
            <div className="submit text-center ">
              <Button className="mt-5 sign px-5" type="submit">
                Sign Up
              </Button>
              <p className="mt-4">Already have an account? <span> <Link className='text-decoration-none   '
